        ...
        <Card>
            <Form onSubmit={handleSubmit.bind(undefined,props)}>
                <Row>
                    ...
                    <Col span={12}  >
                        <FormItem>
                            <Button size='small' type='primary' htmlType="submit" style={{ marginTop:'5px',marginLeft:'20px' }}>查询</Button>
                            <Button size='small' style={{ marginTop:'5px',marginLeft:'10px' }} onClick={reset.bind(undefined,props)}>重置</Button>
                        </FormItem>
                    </Col>
                </Row>
            </Form>
