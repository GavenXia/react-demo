...
const advancedFields =(getFieldValue)=>[
  {
      label:'项目名称',
      fieldName:'projectId',
      type:'asyncSelect',
...
const columns = [
    ...
    },
    {
        ...
        children:[
            {
                title:['增值税收入确认金额','增值税开票金额','未开具发票销售金额'],
                dataIndex:['sumTotalPrice','sumTotalAmount','sumNoInvoiceSales'],
                render:(text,record)=><div className='table-money'>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#000'}}>{fMoney(record.sumTotalPrice)}</p>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#ccc'}}>{fMoney(record.sumTotalAmount)}</p>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#ccc'}}>{fMoney(record.sumNoInvoiceSales)}</p>
                       </div>
            }
        ]
    },
    {
        ...
        children:[
            {
                title:['增值税收入确认金额','增值税开票金额','未开具发票销售金额'],
                dataIndex:['totalPrice','totalAmount','noInvoiceSales'],
                render:(text,record)=><div className='table-money'>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#000'}}>{fMoney(record.totalPrice)}</p>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#ccc'}}>{fMoney(record.totalAmount)}</p>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#ccc'}}>{fMoney(record.noInvoiceSales)}</p>
                       </div>
            }
        ]
    },
    {
        ...
        children:[
            {
                title:['增值税收入确认金额','增值税开票金额','未开具发票销售金额'],
                dataIndex:['endTotalPrice','endTotalAmount','endNoInvoiceSales'],
                render:(text,record)=><div className='table-money'>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#000'}}>{fMoney(record.endTotalPrice)}</p>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#ccc'}}>{fMoney(record.endTotalAmount)}</p>
                         <p style={{marginBottom:'0px',lineHeight:'1.5',color:'#ccc'}}>{fMoney(record.endNoInvoiceSales)}</p>
                       </div>
            }
        ]
    },
