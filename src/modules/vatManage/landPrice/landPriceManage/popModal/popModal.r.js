                        ...
                        <Col span={12}>
                            ...
                            >
                                <div style={{position:'relative'}}>
                                    <Icon type="search" onClick={() => { this.showModal() }} style={{ cursor: "pointer", padding: "5px 10px", position: "absolute", right: "-1px", top: "14px", textAlign: 'right', width: '100%', zIndex: 1,display:'inline-block' }} />
                                    {
