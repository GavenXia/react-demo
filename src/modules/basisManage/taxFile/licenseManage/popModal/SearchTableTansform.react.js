                        ...
                        >
                            <Form onSubmit={this.handleSubmit} style={{display:expand?'block':'none'}}>
                                <Row>
                                    ...
                                    {
                                        searchOption && searchOption.fields &&
                                        (<Col span={8} className="btnAlignCenter">
                                    ...
                                    <Col className="btnAlignCenter" style={{paddingTop:5}} span={actionOption.span||2} offset={(searchOption && searchOption.fields)?6:(actionOption.span?(24-actionOption.span):22)}>
                                        {actionOption.body}
                                    </Col>
                                </Row>
                            </Form>
