...
import {AsyncTable,AdvancedFilter} from '../../index'
import {getFields} from 'utils'
class SearchTable extends Component{
    static propTypes = {
        searchOption:PropTypes.object,
        advancedOptions:PropTypes.object,//添加高级筛选
    ...
    render() {
        const {tableUpDateKey,filters,expand,advancedFilterShow} = this.state;
        const {searchOption,tableOption,children,form,spinning,style,advancedOptions} = this.props;
        return(
                            ...
                            >
                                <Form onSubmit={this.handleSubmit} style={{display:expand?'block':'none'}}>
                                    <Row>
                                        ...
                                        {advancedOptions&&<Col  style={{width:'100%',textAlign:'right'}}>
